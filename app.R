...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(2,
           actionButton("find_match2", "^^", style='padding-top:2px;padding-bottom:0px'), br(),
           actionButton("find_match2", "^", style='padding-top:2px;padding-bottom:0px'), br(),
           actionButton("find_mismatch2", "v", style='padding-top:0px;padding-bottom:2px'), br(),
           actionButton("find_mismatch2", "vv", style='padding-top:0px;padding-bottom:2px'), align="center"),
    column(3, align="center",
