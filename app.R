  ...
  fluidRow(
    ...
    column(1, 
           actionButton("find_match1",
                        ...
                        style='padding:2px; color:white; background-color:rgb(51,122,183); border-color:white'),
           br(),
           actionButton("find_match1",
                        "", icon=icon("angle-up"), width='100%',
                        style='padding:0px; color:white; background-color:rgb(144, 201, 249); border-color:white'),
           br(),
    ...
    column(1, align="left", style='padding:2px',
           actionButton("find_match2",
                            "", icon=icon("angle-double-up"), width='100%',
                            style='font-size:10pt; padding-top:2px;padding-bottom:2px; color:white; background-color:rgb(51,122,183); border-color:white'),
           br(),
           actionButton("find_match2",
                        "", icon=icon("angle-up"), width='100%',
                        style='font-size:9pt; padding-top:1px;padding-bottom:1px; color:white; background-color:rgb(81,152,213); border-color:white'),
           br(),
